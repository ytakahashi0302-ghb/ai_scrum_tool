...
- **Resizable 3-Pane UX**: カンバン、Terminal Dock、AI Team Leader の幅と高さをドラッグで調整できます。
...
| **Resizable 3-Pane UI** | Kanban / Terminal / AI Leader のレイアウトを作業スタイルに合わせて調整 |
...
*MicroScrum AI v1.1.0 - AI-native Scrum for solo builders.*
