...
pub fn run() {
    let migrations = vec![
        ...
        Migration {
            version: 18,
            description: "retrospective_notes",
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            db::start_sprint,
            db::complete_sprint,
            db::get_retro_sessions,
            db::get_retro_session,
            db::create_retro_session,
            ...
            db::approve_retro_item,
            db::get_retro_rules,
            db::add_retro_rule,
            db::update_retro_rule,
            db::delete_retro_rule,
            db::get_project_notes,
            db::add_project_note,
            db::update_project_note,
            db::delete_project_note,
